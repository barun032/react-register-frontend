// src/components/CreateForm.js (Refined Version)
import React, { useState } from 'react';
import { registerFields, registerTypes } from '../data/registerData';

// Minimal field groups - just separate sections
const registerFieldGroups = {
  [registerTypes.DISPATCH]: [
    'date', 'to', 'subject', 'reference',
    'fileNo', 'collectionTitle', 'fileNumber', 'replyDetails', 
    'reminderNumber', 'reminderDate', 'stampRupees', 'stampPaise', 'remarks'
  ],
  [registerTypes.RECEIVE]: [
    'date', 'from', 'subject', 'referenceNo', 'referenceDate',
    'department', 'actionRequired', 'followupDate', 'followupType', 'status', 'remarks'
  ],
  [registerTypes.ISSUED]: [
    'date', 'itemName', 'quantity', 'unit',
    'issuedTo', 'department', 'authorizedBy', 'authorizationDate',
    'status', 'remarks'
  ]
};
