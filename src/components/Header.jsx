...
const Header = ({ onCreateClick, onDashboardClick }) => {
  ...
  const handleLogout = () => {
    setIsUserMenuOpen(false);
    // Add actual logout logic here (e.g., clear localStorage, reload page)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center py-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            ...
            {/* --- ADMIN DROPDOWN SECTION START --- */}
            <div className="relative mx-[50px]" ref={menuRef}>
              <button
                onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}
                className="flex flex-col items-center text-gray-500 hover:text-slate-700 transition-colors duration-200 cursor-pointer"
                title="User Menu"
              >
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-slate-50 hover:text-slate-900 transition-colors flex items-center gap-3 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-sm text-rose-600 hover:bg-rose-50 transition-colors flex items-center gap-3 cursor-pointer"
                  >
